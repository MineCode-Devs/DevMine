...
use devmine\server\events\entity\EntityBlockChangeEvent;
...
class FallingSand extends Entity{
	...
	protected function initEntity(){
		parent::initEntity();
		if(isset($this->namedtag->solidentityID)){
			$this->blockId = $this->namedtag["solidentityID"];
		}elseif(isset($this->namedtag->solidentity)){
			$this->blockId = $this->namedtag["solidentity"];
			$this->namedtag["solidentityID"] = new IntTag("solidentityID", $this->blockId);
		}
