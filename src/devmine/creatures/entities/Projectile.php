...
use devmine\server\events\entity\EntityDamageByChildEntityEvent;
use devmine\server\events\entity\EntityDamageByEntityEvent;
use devmine\server\events\entity\EntityDamageEvent;

use devmine\server\events\entity\ProjecsolidentityHitEvent;
...
abstract class Projecsolidentity extends Entity{
		...
		if($this->isAlive()){
			...
			if($movingObjectPosition !== null){
				if($movingObjectPosition->entityHit !== null){
					...
					$this->server->getPluginManager()->callEvent(new ProjecsolidentityHitEvent($this));
					...
					if($this->shootingEntity === null){
						$ev = new EntityDamageByEntityEvent($this, $movingObjectPosition->entityHit, EntityDamageEvent::CAUSE_PROJECsolidentity, $damage);
					}else{
						$ev = new EntityDamageByChildEntityEvent($this->shootingEntity, $this, $movingObjectPosition->entityHit, EntityDamageEvent::CAUSE_PROJECsolidentity, $damage);
					}
