...
class MakePluginCommand extends VanillaCommand{
	...
	public function __construct($name){
		...
		$this->setPermission("devmine.command.makeplugin");
	}
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$pharPath = Server::getInstance()->getPluginPath() . DIRECTORY_SEPARATOR . "devmine" . DIRECTORY_SEPARATOR . $description->getName() . "_v" . $description->getVersion() . ".phar";
