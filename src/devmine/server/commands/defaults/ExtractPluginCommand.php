...
class ExtractPluginCommand extends VanillaCommand{
	...
	public function __construct($name){
		...
		$this->setPermission("devmine.command.extractplugin");
	}
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$folderPath = Server::getInstance()->getPluginPath().DIRECTORY_SEPARATOR . "devmine" . DIRECTORY_SEPARATOR . $description->getName()."_v".$description->getVersion()."/";
