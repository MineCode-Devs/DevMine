...
use devmine\inventory\blocks\Sand;
use devmine\inventory\blocks\Wood;
use devmine\inventory\blocks\Wood2;
use devmine\inventory\blocks\Slab as StoneSlab;
use devmine\inventory\blocks\WoodSlab as WoodenSlab;
...
use devmine\inventory\blocks\DoublePlant;
use devmine\inventory\blocks\TallGrass;
use devmine\inventory\blocks\Sapling;
use devmine\inventory\blocks\Leaves;
use devmine\inventory\blocks\Leaves2;
use devmine\inventory\blocks\SkullBlock as Skull;

use devmine\inventory\items\Coal;
...
class CreativeItems{
	...
	const ITEMS = [
		...
		self::CATEGORY_MISCELLANEOUS => [
			...
			["id" => Item::ENCHANTED_BOOK, "ench" => [["id" => Enchantment::TYPE_ARMOR_PROJECsolidentity_PROTECTION, "lvl" => 1]]],
			["id" => Item::ENCHANTED_BOOK, "ench" => [["id" => Enchantment::TYPE_ARMOR_PROJECsolidentity_PROTECTION, "lvl" => 2]]],
			["id" => Item::ENCHANTED_BOOK, "ench" => [["id" => Enchantment::TYPE_ARMOR_PROJECsolidentity_PROTECTION, "lvl" => 3]]],
			["id" => Item::ENCHANTED_BOOK, "ench" => [["id" => Enchantment::TYPE_ARMOR_PROJECsolidentity_PROTECTION, "lvl" => 4]]],
