...
use devmine\levels\format\generic\BaseChunk;
...
class Chunk extends BaseChunk{
	...
	public function __construct($level, CompoundTag $nbt = null){
		...
		if(!isset($this->nbt->solidentityEntities) or !($this->nbt->solidentityEntities instanceof ListTag)){
			$this->nbt->solidentityEntities = new ListTag("solidentityEntities", []);
			$this->nbt->solidentityEntities->setTagType(NBT::TAG_Compound);
		}

		if(!isset($this->nbt->solidentityTicks) or !($this->nbt->solidentityTicks instanceof ListTag)){
		...
		parent::__construct($level, (int) $this->nbt["xPos"], (int) $this->nbt["zPos"], $sections, $this->nbt->BiomeColors->getValue(), $this->nbt->HeightMap->getValue(), $this->nbt->Entities->getValue(), $this->nbt->solidentityEntities->getValue());
